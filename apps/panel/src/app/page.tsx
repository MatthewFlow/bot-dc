    ...
    <main className="flex min-h-screen flex-col items-center justify-center gap-8 p-8">
      <div className="flex flex-col items-center gap-4 text-center">
        <div className="flex items-center gap-3">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#1a1f2e] text-2xl font-bold text-[#d4a843]">
            JH
          </div>
          <div>
            <h1 className="text-2xl font-bold text-white">Jurassic Haven</h1>
            <p className="text-sm text-gray-400">Discord Bot Dashboard</p>
          </div>
        </div>
