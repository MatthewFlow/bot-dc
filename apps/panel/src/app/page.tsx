    ...
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden p-6">
      ...
      <div className="relative z-10 flex w-full max-w-md flex-col items-center gap-8 text-center">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="flex h-16 w-16 items-center justify-center rounded-2xl border border-white/10 bg-card text-2xl font-bold text-primary shadow-lg shadow-black/40">
            JH
          </div>
          <div>
        ...
        <a
          ...
          className="flex items-center gap-3 rounded-xl bg-discord px-6 py-3 font-semibold text-white shadow-lg shadow-discord/20 outline-none transition hover:-translate-y-0.5 hover:bg-[#4752c4] focus-visible:ring-2 focus-visible:ring-white/40"
        >
        ...
        <div className="grid w-full grid-cols-2 gap-3 pt-2">
          {FEATURES.map((f) => {
            ...
            return (
              <div
                key={f.label}
                className="flex flex-col gap-1.5 surface-raised rounded-xl border border-border bg-card/70 p-4 text-left"
              >
